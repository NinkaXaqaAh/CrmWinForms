...
partial class CustomerListForm
{
    ...
    private void InitializeComponent()
    {
        ...
        _searchTextBox = new TextBox
        {
            ...
            PlaceholderText = "Поиск по имени, телефону, email...",
        ...
        _searchButton = MakeBtn("Найти", 480, OnSearchClick, accent: false);
        ...
        {
            _searchTextBox, _statusFilter, _searchButton,
        ...
        // Грид — все цвета через AppPalette, чтобы тёмная тема рисовала корректно.
        ...
        // Статусбар. ToolStripProfessionalRenderer не уважает дефолтные цвета формы —
        // нужно ставить BackColor/ForeColor явно, иначе на тёмной теме чёрный текст.
