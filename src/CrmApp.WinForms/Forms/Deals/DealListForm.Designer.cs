...
partial class DealListForm
{
    ...
    private void InitializeComponent()
    {
        ...
        _stageFilter.SelectedIndexChanged += OnFilterChanged;
        ...
        _pdfButton = MakeBtn("PDF-отчёт", 0, OnPdfClick, accent: false);
        ...
        {
            _searchTextBox, _stageFilter, _searchButton,
            _exportButton, _pdfButton, _addButton, _editButton, _deleteButton
        });
        _toolbar.Resize += (_, _) =>
        {
            ...
            x -= _pdfButton.Width + 5; _pdfButton.Location = new Point(x, 12);
