...
partial class ProductListForm
{
    ...
    private void InitializeComponent()
    {
        ...
        _searchTextBox = new TextBox
        {
            ...
            PlaceholderText = "Поиск по названию, артикулу, категории...",
        ...
        _activeOnlyCheck.CheckedChanged += OnFilterChanged;
        ...
        {
            _searchTextBox, _activeOnlyCheck, _searchButton,
            _exportButton, _addButton, _editButton, _deleteButton,
        });
        _toolbar.Resize += (_, _) =>
        {
            _searchButton.Location = new Point(_activeOnlyCheck.Right + 10, 12);
    ...
    private static DataGridView MakeStandardGrid() => new()
    {
        Dock = DockStyle.Fill,
